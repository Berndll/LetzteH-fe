...
\begin{document}
    ...
    \include{Grundkonzepte/main}

    \include{Widerstand/main}

    \include{Kirchhoff/main}

    \include{Leistung/main}

    \include{Quellen/main}

    \include{Felder/main}

    \include{dB/main}

    \include{Wechselstrom/main}

    \include{LineareBauteile/main}

    \include{Halbleiter/main}
